...
let v = arrReverse.length - 1;
while (v >=0) {
    console.log(arrReverse[v]);
    v --;
}
...
let o = arrReverse.length - 1;
while (o >= 0) {
    if (o % 2 !== 0) {
        console.log(arrReverse[o])
    }
    o--
}
...
let t = arrReverse.length;
while (t >= 0) {
    if (t % 2 === 0) {
        console.log(arrReverse[t])
    }
    t --;
}
...
//                  Class work lesson3 (part 2 - get js into html)
...
document.write(`<p>template 1.1</p>`)
document.write(`<ul>`)
...
for (let simpson of simpsons) {
    ...
    for (let key in simpson) {
        document.write(key + ' - ',' ' + simpson[key] + '; ')
    }
    document.write(`</div>`)
}
